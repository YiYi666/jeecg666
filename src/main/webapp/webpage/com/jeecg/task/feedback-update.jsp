...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="feedbackController.do?doUpdate" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						    <input id="fbCourse" name="fbCourse" type="text" style="width: 150px" class="inputxt"  datatype="*"  ignore="checked"  value='${feedbackPage.fbCourse}'/>
					...
					<tr>
						...
						<td class="value">
									  <input id="fbDate" name="fbDate" type="text" style="width: 150px"  class="Wdate" onClick="WdatePicker()"  ignore="ignore" value='<fmt:formatDate value='${feedbackPage.fbDate}' type="date" pattern="yyyy-MM-dd"/>'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value" >
                                ...
                                <textarea name="fbProblem" id="fbProblem" style="width: 650px;height:300px">${feedbackPage.fbProblem }</textarea>
					...
					<tr>
						...
						<td class="value" >
                                <textarea name="fbAdvise" id="fbAdvise" style="width: 650px;height:300px">${feedbackPage.fbAdvise }</textarea>

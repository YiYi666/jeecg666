...
function loadTree() {
	...
	jQuery.ajax({  
        ...
        type: 'POST',  
        dataType : "json",  
        url: 'feedbackController.do?getTreeFeedbackData',//请求的action路径
	...
	var ztreeCreator = new ZtreeCreator('orgTree',"feedbackController.do?getTreeData",zNodes)
...
function zTreeOnLeftClick(event, treeId, treeNode) {
	...
	var url = "feedbackController.do?list";
